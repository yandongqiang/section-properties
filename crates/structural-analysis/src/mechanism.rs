...
use section_properties::fea::{PIVOT_TOL_BASE, SparseMatrix};
...
/// [`SolverCapabilities::dense`](section_properties::fea::solver::SolverCapabilities::dense)'s
/// `max_size`, which
/// [`SolverRegistry::auto_select_info`](section_properties::fea::solver::SolverRegistry::auto_select_info)
