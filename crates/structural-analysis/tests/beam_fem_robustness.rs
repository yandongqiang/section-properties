...
fn test_non_finite_loads_rejected() {
    ...
    bypass
        .distributed_loads
        .push(structural_analysis::beam_fem::DistributedLoad::new(
            0,
            f64::NAN,
            0.0,
        ));
    ...
    bypass_pl
        .point_loads
        .push(structural_analysis::beam_fem::PointLoad::new(
            0,
            0.5,
            0.0,
            f64::NAN,
    ...
    bypass_am
        .applied_moments
        .push(structural_analysis::beam_fem::AppliedMoment::new(
            0,
            f64::NAN,
        ));
    assert!(matches!(
